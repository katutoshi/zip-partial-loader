...
// 切り出し、更に Worker からの相対 import (../resolver, ../types, ./kzpl-wrapper など)
// を再帰的にたどってバンドルする。
...
function createDefaultWorker(): Worker {
  return new Worker(new URL('../kzplw/kzplw.js', import.meta.url), { type: 'module' });
}
...
export default class WorkerWrapper {
  ...
  constructor(
    ...
    // dist/kzplw/kzplw.js は ESM (`import` を含む) として出力されるため、
